...
protected:
	...
	// takes a permutation and writes it as a product of coset representatives if possible.
	// if not, it adds the modified permutation to a list of coset representatives when add=true.
